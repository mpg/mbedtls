    ...
    'analyze_driver_vs_reference_cipher_aead': {
        ...
        'args': {
            ...
            'ignored_suites': [
                ...
                'aes.cbc', 'aes.cfb', 'aes.ecb', 'aes.ofb', 'aes.rest', 'aes.xts',
                'aria', 'camellia', 'des', 'chacha20',
                # AEAD modes
                'ccm', 'chachapoly',
                'gcm.aes128_de', 'gcm.aes128_en', 'gcm.aes192_de',
                'gcm.aes192_en', 'gcm.aes256_de', 'gcm.aes256_en',
                'gcm.camellia', 'gcm.misc',
                # The Cipher abstraction layer
                'cipher.aes', 'cipher.aria', 'cipher.camellia', 'cipher.ccm',
                'cipher.chacha20', 'cipher.chachapoly', 'cipher.des',
                'cipher.gcm', 'cipher.nist_kw', 'cipher.padding',
            ],
            'ignored_tests': {
                # PEM decryption is not supported so far.
                # The rest of PEM (write, unencrypted read) works though.
                'test_suite_pem': [
                    'PEM read .*(AES|DES|encrypt).*'
                ],
